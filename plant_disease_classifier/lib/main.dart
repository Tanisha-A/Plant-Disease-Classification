...
import 'package:plant_disease_classifier/pages/data_used.dart';
import 'package:plant_disease_classifier/pages/model_architecture.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  loadMyModel() async {
    var resultant = await Tflite.loadModel(
      ...
      model: "assets/mobilenetv2_epochs_30_batchsize_128_lr_0.001.tflite"
    );
  ...
  applyModelOnImage(File file) async {
    ...
    setState(() {
      ...
      _name = str?.substring(str.length - (str.length - 2));
